...
if(mysql_num_rows($chkclient) > 0){
	...
	header("Location: admin_home.php?alert=$alert&class=$class&alertmsg=$alertmsg#matters_new");
}
...
if(mysql_num_rows($count) > 0){
	...
	header("Location: admin_home.php?alert=$al&class=$class&alertmsg=$alertmessage#matters_new");
	exit();
} 
